...
Our goal in this post is to see why this framework is particularly useful. A good reference is _Gauge Fields, Knots, and Gravity_ by John Baez and Javier P. Muniain.

To start, we can write Maxwell's equations succinctly in terms of these objects; see the [alternate formulations](https://en.wikipedia.org/wiki/Maxwell%27s_equations#Alternative_formulations). First, we have the equation which is always true mathematically:
