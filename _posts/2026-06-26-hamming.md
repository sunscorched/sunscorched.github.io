...
**Remark 1:** The question is equivalent to "Does your hidden sequence fall into the exact set of sequences for which submitting a sequence of all 1s define a win?" So it's tautological. Before you get upset, read on.
