...
But more than that, we get a theorem of Jacobi, proved in 1834, which gives the exact number of 4-tuples $(w,x,y,z) \in \mathbb{Z}^4$ such that $m=w^2+x^2+y^2+z^2$. See this [note](https://web.math.princeton.edu/~ssridhar/resources/Papers/4squareNotes.pdf) for more on this topic of modular forms and sums of squares.
